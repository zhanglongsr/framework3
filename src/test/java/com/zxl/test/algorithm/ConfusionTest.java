...
public class ConfusionTest {
    ...
    public static long encode(long[] ip) {
    ...
    public static void main(String[] args) {
        ...
        long[] ids = { 106, 101, 103, 112 };
        long encodeId = encode(ids);
        System.out.println(encodeId);

        String[] decodeIdsStrings = decode(encodeId);
        System.out.println(decodeIdsStrings.length);
